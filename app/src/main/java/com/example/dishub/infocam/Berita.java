package com.example.dishub.infocam;
...
public class Berita extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        ImageView PP = findViewById(R.id.imageView);
